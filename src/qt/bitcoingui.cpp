                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Dregulate Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Dregulate address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and Dregulate: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zDREG"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Dregulate Core"), this);
    aboutAction->setStatusTip(tr("Show information about Dregulate Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Dregulate"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Dregulate addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Dregulate addresses"));
    ...
    openAction->setStatusTip(tr("Open a Dregulate: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Dregulate Core help message to get a list with possible Dregulate command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Dregulate Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Dregulate network", "", count));
}
...
{
    QString strTitle = tr("Dregulate Core"); // default title
