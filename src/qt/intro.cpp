...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Dregulate Core"),
     ...
     * override -datadir in the Dregulate.conf file in the default data directory
     * (to be consistent with Dregulated behavior)
     */
    if (dataDir != getDefaultDataDirectory())
