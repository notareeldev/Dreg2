                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received DREG from zDREG"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zDREG"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zDREG));
