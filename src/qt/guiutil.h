...
/** Utility functions used by the Dregulate Qt UI.
 */
namespace GUIUtil
{
...
// Render Dregulate addresses in monospace font
...
// Parse "Dregulate:" URI into recipient object, return true on successful parsing
