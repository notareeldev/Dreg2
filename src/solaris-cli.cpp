...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("Dregulate Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                        "  Dregulate-cli [options] <command> [params]  " + _("Send command to Dregulate Core") + "\n" +
                        "  Dregulate-cli [options] help                " + _("List commands") + "\n" +
                        "  Dregulate-cli [options] help <command>      " + _("Get help for a command") + "\n";
