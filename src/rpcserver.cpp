...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Dregulate server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Dregulate server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Dregulate features */
        {"Dregulate", "masternode", &masternode, true, true, false},
        {"Dregulate", "listmasternodes", &listmasternodes, true, true, false},
        {"Dregulate", "getmasternodecount", &getmasternodecount, true, true, false},
        {"Dregulate", "masternodeconnect", &masternodeconnect, true, true, false},
        {"Dregulate", "masternodecurrent", &masternodecurrent, true, true, false},
        {"Dregulate", "masternodedebug", &masternodedebug, true, true, false},
        {"Dregulate", "startmasternode", &startmasternode, true, true, false},
        {"Dregulate", "createmasternodekey", &createmasternodekey, true, true, false},
        {"Dregulate", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"Dregulate", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"Dregulate", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"Dregulate", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"Dregulate", "getmasternodescores", &getmasternodescores, true, true, false},
        {"Dregulate", "mnbudget", &mnbudget, true, true, false},
        {"Dregulate", "preparebudget", &preparebudget, true, true, false},
        {"Dregulate", "submitbudget", &submitbudget, true, true, false},
        {"Dregulate", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"Dregulate", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"Dregulate", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"Dregulate", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"Dregulate", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"Dregulate", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"Dregulate", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"Dregulate", "checkbudgets", &checkbudgets, true, true, false},
        {"Dregulate", "mnsync", &mnsync, true, true, false},
        {"Dregulate", "spork", &spork, true, true, false},
        {"Dregulate", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"Dregulate", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use Dregulated, or the -server option to Dregulate-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> Dregulate-cli " + methodname + " " + args + "\n";
}
