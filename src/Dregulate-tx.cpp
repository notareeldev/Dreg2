...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Dregulate Core Dregulate-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  Dregulate-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Dregulate transaction") + "\n" +
                               "  Dregulate-tx [options] -create [commands]   " + _("Create hex-encoded Dregulate transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded Dregulate transaction
