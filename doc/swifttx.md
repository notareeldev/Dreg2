...
This mechanism has been integrated into Bitcore-Node-Dregulate which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Dregulate-Project/insight-api-Dregulate#web-socket-api](https://github.com/Dregulate-Project/insight-api-Dregulate#web-socket-api) 
* API: [https://github.com/Dregulate-Project/insight-api-Dregulate#swifttx-transactions](https://github.com/Dregulate-Project/insight-api-Dregulate#swifttx-transactions) 
...
By default, the Dregulate Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Dregulate Core daemon:
