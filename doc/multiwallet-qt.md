...
In order to support loading of multiple wallets in Dregulate-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is Dregulate.cpp.
...
Changes to Dregulate.cpp
----------------------
Dregulate.cpp is the entry point into Dregulate-qt, and as such, will require some minor modifications to provide hooks for
