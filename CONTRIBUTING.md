Contributing to Dregulate Core
============================

The Dregulate Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Dregulate Core project, and is not to be
confused with overall Dregulate Network Protocol consensus changes.

Whether a pull request is merged into Dregulate Core rests with the project merge
...
Patches that change Dregulate consensus rules are considerably more involved than
...
Where a patch set proposes to change the Dregulate consensus, it must have been
...
The project leader is the release manager for each Dregulate Core release.
