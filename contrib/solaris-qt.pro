...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/Dregulate-cli.cpp \
           src/Dregulate-tx.cpp \
           src/Dregulate.cpp \
           src/db.cpp \
           ...
           src/qt/Dregulate.cpp \
           src/qt/Dregulatestrings.cpp \
...
RESOURCES += src/qt/Dregulate.qrc src/qt/Dregulate_locale.qrc

TRANSLATIONS += src/qt/locale/Dregulate_bg.ts \
                src/qt/locale/Dregulate_de.ts \
                src/qt/locale/Dregulate_en.ts \
                src/qt/locale/Dregulate_es.ts \
                src/qt/locale/Dregulate_fi.ts \
                src/qt/locale/Dregulate_fr.ts \
                src/qt/locale/Dregulate_it.ts \
                src/qt/locale/Dregulate_ja.ts \
                src/qt/locale/Dregulate_pl.ts \
                src/qt/locale/Dregulate_pt.ts \
                src/qt/locale/Dregulate_ru.ts \
                src/qt/locale/Dregulate_sk.ts \
                src/qt/locale/Dregulate_sv.ts \
                src/qt/locale/Dregulate_vi.ts \
                src/qt/locale/Dregulate_zh_CN.ts \
                src/qt/locale/Dregulate_zh_TW.ts
